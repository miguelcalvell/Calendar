...
// Puedes añadir EN más adelante; vacío por ahora
...
export function I18nProvider({ children }: { children: React.ReactNode }) {
  ...
  // Versión sin ?. ni ?? para evitar cualquier rareza del parser
  const t = useMemo(() => {
    return (k: string) => {
      const current = DICTS[lang] || ES
      if (Object.prototype.hasOwnProperty.call(current, k)) return current[k]
      if (Object.prototype.hasOwnProperty.call(ES, k)) return ES[k]
      return k
    }
  }, [lang])
